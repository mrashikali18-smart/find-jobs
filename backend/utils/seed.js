...
const run = async () => {
  ...
  const jobsData = [
    ...
    { title: 'Graphic Designer', category: 'Design', jobType: 'freelance', experienceLevel: 'entry', location: 'Remote', isRemote: true, skills: ['Photoshop', 'Illustrator'], salaryMin: 20000, salaryMax: 40000, description: 'Create marketing visuals and social media assets.', requirements: ['Design portfolio'] },
